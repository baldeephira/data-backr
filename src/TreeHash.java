...
/**
 * TreeHash class calculates the TreeHash value of the given file.  This TreeHash
 * implementation is compatible with TreeHash values that are generated by AWS
 * when file archives are uploaded. It is a standalone class that has main method
 * that prints out the tree hash value on console.
 */
